...
namespace CineBook.Migrations
{
    ...
    [Migration("20250123152234_adding ClosedAt prop to SupportTicket Model")]
    partial class addingClosedAtproptoSupportTicketModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CineBook.Models.Chat", b =>
                {
            ...
            modelBuilder.Entity("CineBook.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CineBook.Models.SupportTicket", b =>
                {
                    b.Property<string>("TicketId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CineBook.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
